...
const HowToPlay = (props) => {
  return (
    <>
      <div className="howtoplay-Container-Login">
        <div className="howtoplay-number-container">1</div>
        <div className="howtoplay-Text">Log in with your Spotify account.</div>
        <div className="howtoplay-Login-Container">
          ...
          <div className="howtoplay-home_page_bottom">
            <div
              className="u-background-brightgreen howtoplay-home-button u-pointer"
      ...
      <div className="howtoplay-Container">
        ...
        <div className="howtoplay-Text">
          You will earn 10 points per correct answer and lose 5 points for each incorrect answer. If
          you buzz before the 15 second mark, you will receive 15 points.
        </div>
        <div className="howtoplay-Image-Container">
