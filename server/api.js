...
router.post("/submitted", (req, res) => {
  ...
  socketManager
    ...
    .emit("submitted", { submission: req.body.sub, name: req.body.user.name, early: req.body.early});
  res.send({});
});
...
router.post("/newGame", (req, res) => {
  ...
  console.log("code is: " + code);
    games.set(code, {
      ...
      userData: [{ _id: req.body.userId, name: req.body.name, score: 0, active: true, buzzed: false}],
      userBuzz: null,
      gameChat: [],
      gameLog: [],
...
router.post("/joinGame", (req, res) => {
  if (games.get(req.body.gameCode)) {
    ...
    if (flag) {
      game.userData.push({ _id: req.body.userId, name: req.body.name, score: 0, active: true, buzzed: false});
